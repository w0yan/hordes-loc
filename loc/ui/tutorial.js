...
export default {
  msg: [
    { // _TUT_MOVE
      ...
      pt: 'Bem-vindo! Pressione <kbd>W A S D</kbd> ou <kbd>⭠ ⭢ ⭡ ⭣</kbd> para se mover.'
    },
    { // _TUT_CAMERA
      ...
      pt: 'Ótimo trabalho! Agora, <kbd>clique esquerdo/direito</kbd> e arraste o mouse para rotacionar a câmera.'
    },
    { // _TUT_UISELECTUNIT
      ...
      pt: 'Avance e encontre um monstro, depois selecione-o clicando com o mouse ou pressionando <kbd>TAB</kbd>.'
    },
    { // _TUT_CASTSPELL
      ...
      pt: 'Você pode atacar pressionando as teclas da sua barra de habilidades. Pressione <kbd>1</kbd> no teclado para atacar o monstro!'
    },
    { // _TUT_KILLMOB
      ...
      pt: 'Perfeito! Continue assim e acabe com o monstro!'
    },
    { // _TUT_EXPREWARD
      ...
      pt: 'Bom trabalho. Você foi recompensado com pontos de experiência.'
    },
    { // _TUT_EXPINFO
      ...
      pt: 'Colete pontos de experiência suficientes e você subirá de nível.'
    },
    { // _TUT_FINDITEM
      ...
      pt: 'Você pode pressionar <kbd>Shift</kbd> para ver itens e moedas no chão. Pegue um item!'
    },
    { // _TUT_OPENBAG
      ...
      pt: 'Você pegou um item. Abra seu inventário (<kbd>B</kbd>) para vê-lo.'
    },
    { // _TUT_BAGMEME
      ...
      pt: 'Aqui você pode ver seus itens. O tamanho do inventário depende da bolsa que você tem equipada.'
    },
    { // _TUT_EQUIPITEM
      ...
      pt: 'Você pode equipar itens clicando com o botão direito sobre eles e selecionando "Equipar item".'
    },
    { //  _TUT_OPENCHARPANEL
    ...
    { // _TUT_CHARPANELINFO
      ...
      pt: 'Você pode ver todos os itens equipados no painel do seu personagem.'
    },
    { // _TUT_GOLEVELUP
      ...
      pt: 'Em seguida, tente subir de nível matando monstros.'
    },
    { // _TUT_OPENCHARPANEL2
      ...
      pt: 'Você subiu de nível e ganhou pontos de status. Abra novamente o painel do seu personagem (<kbd>C</kbd>).'
    },
    { //  _TUT_USESTATPOINTS
      ...
      pt: 'Pontos de status podem ser usados para aumentar seus atributos principais. Passe o cursor sobre os botões para pré-visualizar os efeitos e então use seus pontos de status.'
    },
    { // _TUT_LEVELUPTONEWSKILL
      ...
      pt: 'A seguir, vamos ensinar como aprender novas habilidades. Primeiro, suba até o nível 3 para desbloquear uma nova habilidade.'
    },
    { // _TUT_NEWSKILLEXPLANATION
      ...
      pt: 'Uma nova habilidade está disponível. Você precisa usar livros para aprender novas habilidades.'
    },
    { // _TUT_COLLECTBOOKCOINS
      ...
      pt: 'Colete alguns itens e moedas. Você precisa de 32 moedas para seu primeiro livro. Você também pode vender itens ao comerciante.'
    },
    { // _TUT_VISITTRADER
      ...
      pt: 'Você tem moedas suficientes. Volte para sua base e fale com o comerciante da sua classe para comprar seu novo livro de habilidade.'
    },
    { // _TUT_BUYSKILLBOOK
      ...
      pt: 'O comerciante vende livros de habilidades, poções e montarias. Clique com o botão direito no livro para comprá-lo.'
    },
    { // _TUT_USETHEBOOK
      ...
      pt: 'Depois de ter o livro, abra seu inventário, clique com o botão direito no livro e selecione <kbd>Usar objeto</kbd> para aprendê-lo.'
    },
    { // _TUT_OPENSKILLMENU
      ...
      pt: 'Feche a janela do comerciante e depois abra seu painel de habilidades (<kbd>K</kbd>) para ver um resumo das suas habilidades.'
    },
    { // _TUT_HOVEROVERSKILLS
      ...
      pt: 'Aqui você pode ver suas habilidades. Passe o cursor sobre elas para informações adicionais. Habilidades normalmente requerem um ponto de habilidade, que você ganha a cada dois níveis.'
    },
    { // _TUT_ADDSKILLPOINT
      ...
      pt: 'Você pode mudar seu conjunto de habilidades a qualquer momento. Adicione um ponto de habilidade para ativá-la.'
    },
    { // _TUT_APPLYSKILLS
      ...
      pt: 'Agora pressione "Aplicar" para ativar seu novo conjunto de habilidades.'
    },
    ...
    { // _TUT_TEXT1
      ...
      pt: 'Você aprendeu muito. Está quase pronto para começar sua aventura.'
    },
    { // _TUT_PARTYBUTTON
      ...
      pt: 'Hordes é sobre trabalhar em grupo com outros jogadores. Clique em <kbd>Sem grupo</kbd> ou pressione <kbd>P</kbd> para abrir o buscador de grupos.'
    },
    { // _TUT_PARTYBUTTON2
      ...
      pt: 'Clique em um grupo de nivelamento adequado ao seu nível. Em seguida, pressione <kbd>Aplicar</kbd>.'
    },
    { //  _TUT_PARTYINFO
      ...
      pt: 'Um xamã irá invocá-lo em breve. Alternativamente, pressione <kbd>M</kbd> para abrir o mapa e ver para onde você deve ir.'
    },
    { // _TUT_PARTYINFO2
      ...
      pt: 'Parabéns por alcançar o nível 9! Em breve você poderá entrar no próximo grupo através do buscador de grupos. <kbd>P</kbd>'
    },
    { // _TUT_REMAINDER_TO_STATUP
      ...
      pt: 'Ao subir de nível, você ganhará pontos de habilidade e pontos de status adicionais. Lembre-se de aumentar o nível das suas habilidades com <kbd>K</kbd> e de alocar os pontos de status com <kbd>C</kbd>.'
    },
    { // _TUT_BOOKS_EXTRA_INFO
      ...
      pt: 'Dica: Todos os livros de habilidade de Nível 1 podem ser comprados com o comerciante da sua classe. Livros de nível mais alto podem ser encontrados em monstros.'
    },
    { // _TUT_MERCHANT_INFO
      ...
      pt: 'Dica: Você pode trocar itens com outros jogadores. Para isso, visite o Mercador. Ele usa um grande chapéu verde.'
    },
    { // _TUT_MERCHANT_STASH
      ...
      pt: 'Dica: Todos os itens comprados no mercador serão enviados para o seu baú — um armazenamento para seus itens e ouro. É uma caixa marrom localizada ao lado do mercador.'
    },
    { // _TUT_BLACKSMITH
      ...
      pt: 'Dica: Você encontrará runas ao derrotar monstros. As runas permitem melhorar seus itens. Visite o ferreiro para fazer isso.'
    },
    { // _TUT_CHAT
      ...
      pt: 'Dica: Você pode pressionar <kbd>Enter</kbd> para conversar. Pode usar os canais <kbd>/party</kbd>, <kbd>/faction</kbd> e <kbd>/clan</kbd>.'
    },
    { // _TUT_PVP1
      ...
      pt: 'Dica: Jogadores da outra facção podem ser derrotados para ganhar fama e itens (como a coroa) para seu personagem.'
    },
    { // _TUT_PVP2
      ...
      pt: 'Dica: Estar em grupo também permite compartilhar pontos de fama em combates PvP.'
    },
    { // _TUT_SETTINGS
      ...
      pt: 'Dica: Pressione o ícone de engrenagem no canto superior direito para abrir as configurações. Você pode alterar os controles, mensagens do chat, configurações da interface e gráficos.'
    },
    { // _TUT_HELLSPAWN
      ...
      pt: 'Dica: Quando os monstros em Hordes são mortos rapidamente, eles entram no estado "Hellspawn", reaparecendo com mais vida e deixando mais saque. Isso permite que grupos farmem recursos juntos.'
    },
    { // _TUT_HELLSPAWN2
      ...
      pt: 'Dica: Monstros Hellspawn de alto nível no fim do jogo têm chance de dropar mascotes raros, que podem ser vendidos para outros jogadores.'
    },
    { // _TUT_OBELISK
      ...
      pt: 'Dica: O Obelisco é um evento PvP de fim de jogo que dura uma hora e se repete a cada 3 horas. Você pode visitar o Conjurador de Guerra para se teletransportar para uma batalha PvP.'
    },
    { // _TUT_OBELISK2
      ...
      pt: 'Dica: Ao vencer uma luta no Obelisco, você recebe uma <kbd>Bênção de Ossos</kbd>. Esse buff concede drops extras de chefes.'
    },
    { // _TUT_GLOOMFURY
      ...
      pt: 'Dica: Após o evento do Obelisco, Gloomfury aparece no centro de Faivel. Ele é um chefe poderoso e deixa loot baseado no seu desempenho pessoal.'
    },
    { // _TUT_ENDGAME
      ...
      pt: 'Dica: Os eventos de endgame em Hordes acontecem em um ciclo de 3 horas: uma hora de Obelisco PvP, uma hora de Gloomfury e uma hora de pausa.'
    },
    { // _TUT_RAREMOBS
      ...
      pt: 'Dica: Você sabia que existem montarias raras em Hordes? Elas podem ser encontradas quando (raramente) aparecem pelo mundo.'
    },
    { // _TUT_MAXLEVEL
